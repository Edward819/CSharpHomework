...
namespace program1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                int i = 5;
                Console.WriteLine("欢迎来到订单管理平台，请输入你想进入的服务：1.查询订单 2.修改订单 3.删除订单 4.增加订单 5.输出价格高于100的订单 " +
                    "6.将订单载入xml文件 7.从xml中载入订单 8.离开");
                try
                {
                ...
                switch (i)
                {
                    case 1:
                        ...
                        switch (j)
                        {
                            case 1:
                                ...
                                try
                                {
                                    num0 = long.Parse(Console.ReadLine());
                                }
                                catch (Exception e)
                                {
                                ...
                                try
                                {
                                    ...
                                    Console.WriteLine("已查到：" + orderList + "  " + orderService.goodName[flag0] + "  " +
                                        orderService.customerName[flag0] + "  " + orderService.prices[flag0] + "  " + orderService.Phones[flag0]);
                                }
                                catch (Exception e)
                                {
                                    Console.WriteLine(e.Message);
                            ...
                            case 2:
                                ...
                                try
                                {
                                    ...
                                    Console.WriteLine("已查到：" + orderService.Nums[flag1] + "  " + orderService.goodName[flag1] + "  "
                                        + orderService.customerName[flag1] + "  " + orderService.prices[flag1] + "  " + orderService.Phones[flag1]);
                                }
                                catch (Exception e)
                                {
                                    Console.WriteLine(e.Message);
                            ...
                            case 3:
                                ...
                                try
                                {
                                    ...
                                    Console.WriteLine("已查到：" + orderService.Nums[flag2] + "  " + orderService.goodName[flag2] + "  "
                                        + orderService.customerName[flag2] + "  " + orderService.prices[flag2] + "  " + orderService.Phones[flag2]);
                                }
                                catch (Exception e)
                                {
                                    Console.WriteLine(e.Message);
                    ...
                    case 2:
                        ...
                        switch (k)
                        {
                            case 1:
                                ...
                                long num0 = Int32.Parse(Console.ReadLine());
                                Console.WriteLine("请输入你想修改的新订单号:");
                                long num1 = Int32.Parse(Console.ReadLine());
                    ...
                    case 3:
                        ...
                        orderService.deletePhone(flag);
                        Console.WriteLine("OK!");
                        break;
                    case 4:
                        Console.WriteLine("请输入你想添加的订单的订单号：");
                        long hao = Int32.Parse(Console.ReadLine());
                        ...
                        Console.WriteLine("请输入你想添加的订单的商户联系方式：");
